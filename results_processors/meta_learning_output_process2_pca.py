...
def main():
    ...
    results_map.to_csv(os.path.join(result_path, "meta_learning_output_process2_pca.csv"), index=False)
    ...
    results_map.to_csv(os.path.join(result_path, "meta_learning_output_process2_pca_pivoted.csv"), index=False)
    ...
    fig.savefig(os.path.join(result_path, "meta_learning_output_process2_pca.pdf"), bbox_extra_artists=(lgd,text), bbox_inches='tight')
