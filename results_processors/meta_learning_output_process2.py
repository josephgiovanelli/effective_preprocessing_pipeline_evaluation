...
def main():
    ...
    results_map.to_csv(os.path.join(result_path, "meta_learning_output_process2.csv"), index=False)
    ...
    results_map.to_csv(os.path.join(result_path, "meta_learning_output_process2_pivoted.csv"), index=False)
    ...
    fig.savefig(os.path.join(result_path, "meta_learning_output_process2.pdf"), bbox_extra_artists=(lgd,text), bbox_inches='tight')
