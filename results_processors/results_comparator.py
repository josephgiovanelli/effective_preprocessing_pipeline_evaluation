...
def main():
    ...
    comparison, summary = merge_results(auto_results, pseudo_exhaustive_results, 'pseudo_exhaustive', filtered_data_sets)
    ...
    comparison, summary = merge_all_results(auto_results, quemy_results, pseudo_exhaustive_results, 'quemy', 'pseudo_exhaustive', filtered_data_sets)
